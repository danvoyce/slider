  ...
  (0, _createClass3['default'])(Range, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          _onHandleFocus = _props2.onHandleFocus;
      ...
      var handles = bounds.map(function (v, i) {
        ...
        return handleGenerator({
          ...
          max: max,
          disabled: disabled,
          onHandleFocus: function onHandleFocus(i) {
            _onHandleFocus(i);
            _this4.setState({ activeIndex: i });
          },
          activeIndex: _this4.state.activeIndex,
          style: handleStyle[i],
          ref: function ref(h) {
...
Range.propTypes = {
  ...
  onHandleFocus: _propTypes2['default'].func,
