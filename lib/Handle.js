  ...
  function Handle() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3['default'])(this, (_ref = Handle.__proto__ || Object.getPrototypeOf(Handle)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          onHandleFocus = _this$props.onHandleFocus;
  ...
  (0, _createClass3['default'])(Handle, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          onHandleFocus = _props.onHandleFocus,
          restProps = (0, _objectWithoutProperties3['default'])(_props, ['index', 'activeIndex', 'prefixCls', 'vertical', 'offset', 'style', 'disabled', 'min', 'max', 'value', 'tabIndex', 'onHandleFocus']);
      ...
      return _react2['default'].createElement('div', (0, _extends3['default'])({
        ...
        className: (0, _classnames2['default'])(className, { 'active-handle': index === activeIndex }),
        style: elStyle,
